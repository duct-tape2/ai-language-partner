...
- Currently available starter issues: `44`
- Reserved or assigned issues excluded: `4`
- Available good first issues: `21`
- Available help wanted issues: `20`
...
|---|---:|---|
| Mobile/accessibility | 10 | Expo, React Native, labels, touch targets, layout |
| Backend/API docs | 10 | FastAPI, OpenAPI, local STT/TTS setup, provider docs |
...
| [#105: security: add continuous fuzzing for URL and path boundaries](https://github.com/duct-tape2/ai-language-partner/issues/105) | `help wanted`, `backend`, `tests`, `security`, `up-for-grabs`, `ci` |
...
| [#5: docs: add architecture glossary for dialogue-bank terms](https://github.com/duct-tape2/ai-language-partner/issues/5) | `good first issue`, `docs`, `up-for-grabs`, `first-timers-only` |
