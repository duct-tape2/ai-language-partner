...
- Open issues observed: `50`
- Currently available starter issues: `41`
- Reserved or assigned issues excluded: `9`
- Available good first issues: `18`
- Available help wanted issues: `17`
...
|---|---:|---|
| Mobile/accessibility | 9 | Expo, React Native, labels, touch targets, layout |
| Backend/API docs | 8 | FastAPI, OpenAPI, local STT/TTS setup, provider docs |
...
| Korean/Japanese docs | 4 | Setup docs, architecture notes, learner-facing explanation |
| Other | 2 | Useful starter tasks that do not fit another lane |
...
| [#63: security: upgrade Expo SDK 52 through supported releases](https://github.com/duct-tape2/ai-language-partner/issues/63) | `help wanted`, `mobile`, `release`, `security`, `up-for-grabs` |
...
| Issue | Labels |
|---|---|
| [#1: docs: add Korean quick-start for backend mock mode](https://github.com/duct-tape2/ai-language-partner/issues/1) | `help wanted`, `good first issue`, `docs`, `up-for-grabs`, `first-timers-only` |
| [#2: docs: add Japanese quick-start for mobile mock mode](https://github.com/duct-tape2/ai-language-partner/issues/2) | `help wanted`, `good first issue`, `docs`, `up-for-grabs`, `first-timers-only` |
| [#31: docs: add FAQ about why no runtime LLM is used](https://github.com/duct-tape2/ai-language-partner/issues/31) | `good first issue`, `docs`, `up-for-grabs`, `first-timers-only` |
...
Useful starter tasks that do not fit another lane.

| Issue | Labels |
|---|---|
| [#129: [Feature]: Implement Prettier for automated code formatting](https://github.com/duct-tape2/ai-language-partner/issues/129) |  |
| [#130: [Feature]: Implement CODEOWNERS for automated PR review assignment](https://github.com/duct-tape2/ai-language-partner/issues/130) |  |
