...
|---|---|---|---|---|---|---|---|---|
| Open Source Observer OSS Directory | PR | open | False | True | [link](https://github.com/opensource-observer/oss-directory/pull/1114) | [entry](https://duct-tape2.github.io/ai-language-partner/community/CONTRIBUTOR_LANDING.html) | - | validate: completed action_required; Validate PR: completed success |
| Mozilla Codetribute | PR | open | False | True | [link](https://github.com/mozilla-frontend-infra/codetribute/pull/650) | [entry](https://duct-tape2.github.io/ai-language-partner/community/FIRST_ISSUE_MATCHER.html) | - | yarn lint: completed success; yarn test: completed success; yarn build: completed success; Redirect rules - mozilla-codetribute: completed success; Header rules - mozilla-codetribute: completed success; Pages changed - mozilla-codetribute: completed neutral |
...
| Awesome Python Applications | PR | open | False | True | [link](https://github.com/mahmoud/awesome-python-applications/pull/233) | [entry](https://duct-tape2.github.io/ai-language-partner/demo/) | - | none reported |
