...
templates, and 50 scoped starter issues for external language review,
accessibility, docs, tests, FastAPI examples, and Expo polish.
...
- 50 scoped issues for first-time and external contributors
